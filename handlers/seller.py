...
async def handle_statistics(message: Message, state: FSMContext):
    ...
    await message.answer(
        f"📊 Укажите минимальный охват историй:\n\n"
...
async def handle_stories_reach_min(message: Message, state: FSMContext):
    """Обработка ввода минимального охвата историй"""
    input_text = message.text.strip()
    ...
    try:
        ...
        logger.error(f"Ошибка валидации охвата историй (мин): {e}, ввод: '{input_text}'")
        await message.answer(
            "❌ <b>Неверный формат</b>\n\n"
            "Введите целое положительное число.\n"
            f"Ваш ввод: '{input_text}'\n"
    ...
    await message.answer(
        f"📊 Укажите максимальный охват историй:\n\n"
        f"Уже указано: Минимальный охват историй: {stories_reach_min}",
        parse_mode="HTML"
    )
...
async def handle_stories_reach_max(message: Message, state: FSMContext):
    """Обработка ввода максимального охвата историй"""
    input_text = message.text.strip()
    data = await state.get_data()
    ...
    try:
        ...
        if stories_reach_max <= stories_reach_min:
            raise ValueError("Max reach must be greater than min reach")
            
    except ValueError as e:
        logger.error(f"Ошибка валидации охвата историй (макс): {e}, ввод: '{input_text}'")
        await message.answer(
            "❌ <b>Неверный формат</b>\n\n"
            "Введите целое положительное число больше минимального.\n"
            f"Ваш ввод: '{input_text}'\n"
    ...
    await message.answer(
        ...
        f"Уже указано: Охват историй: {stories_reach_min}-{stories_reach_max}",
        parse_mode="HTML"
    )
...
async def handle_reels_reach_min(message: Message, state: FSMContext):
    ...
    try:
        ...
        logger.error(f"Ошибка валидации охвата рилс (мин): {e}, ввод: '{input_text}'")
        await message.answer(
            "❌ <b>Неверный формат</b>\n\n"
            "Введите целое положительное число.\n"
            f"Ваш ввод: '{input_text}'\n"
...
async def handle_reels_reach_max(message: Message, state: FSMContext):
    ...
    try:
        ...
        logger.error(f"Ошибка валидации охвата рилс (макс): {e}, ввод: '{input_text}'")
        await message.answer(
            "❌ <b>Неверный формат</b>\n\n"
            "Введите целое положительное число больше минимального.\n"
            f"Ваш ввод: '{input_text}'\n"
    ...
    await message.answer(
        ...
        f"Уже указано: Охват рилс: {reels_reach_min}-{reels_reach_max}",
        parse_mode="HTML"
    )
